...
(custom-set-variables
 ...
 '(anaconda-mode anzu bash-completion bazel blamer bm cape clang-capf clean-aindent-mode consult-eglot corfu-prescient cpp-auto-include csv-mode ctrlf diminish eldoc-box emojify ergoemacs-mode flycheck git-gutter go-mode helpful indent-bars jinx js2-mode julia-mode kind-icon kotlin-mode langtool loccur marginalia markdown-ts-mode mic-paren minions modern-cpp-font-lock modern-sh orderless paradox perl-ts-mode pos-tip powerline powerthesaurus rainbow-delimiters rainbow-mode rust-mode sdcv shift-number smartparens smooth-scrolling textsize track-changes treemacs-magit treesit-auto treesit-fold undo-fu undo-tree unicode-fonts vertico-prescient volatile-highlights ws-butler yaml-mode))
 '(paradox-github-token t)
 '(rainbow-x-colors nil)
 '(safe-local-variable-values
 '((eval font-lock-add-keywords nil `((,(concat "(" (regexp-opt '("sp-do-move-op" "sp-do-move-cl" "sp-do-put-op" "sp-do-put-cl" "sp-do-del-op" "sp-do-del-cl") t) "\\_>") 1 'font-lock-variable-name-face))) (enable-local-variables: . all)))
 '(tab-width 4)
